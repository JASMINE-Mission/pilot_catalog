...
FROM vvv42_sources_full_clean WHERE (phot_ks_mag>16 or phot_ks_mag is null) AND (source_id not in (SELECT vvv_source_id1 FROM vvv_virac_common) OR source_id not in (SELECT vvv_source_id2 FROM vvv_virac_common))  LIMIT 10
UNION
