...
CREATE TABLE IF NOT EXISTS vvv42_sources_full (
  source_id         BIGINT PRIMARY KEY,
  glon              FLOAT NOT NULL,
  glat              FLOAT NOT NULL,
  ra                FLOAT NOT NULL,
...
CREATE TABLE IF NOT EXISTS virac2_ks16 (
  source_id         BIGINT PRIMARY KEY,
  ...
  chisq             FLOAT,
  uwe               FLOAT,
  phot_z_mean_mag   FLOAT,
  phot_z_std_mag    FLOAT,
  phot_z_n_epochs   INTEGER,
  z_n_obs           INTEGER,
  z_n_det           INTEGER,
  z_n_amb           INTEGER,
  phot_y_mean_mag   FLOAT,
  phot_y_std_mag    FLOAT,
