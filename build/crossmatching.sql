...
FROM vvv_sources_clean as v INNER JOIN tmass_sources_clean as t ON q3c_join(t.ra,t.dec,v.ra,v.dec,1./3600.) AND jhk_match(t.phot_j_mag,v.phot_j_mag,t.phot_h_mag,v.phot_h_mag,v.phot_ks_mag,v.phot_ks_mag,1.0::FLOAT); 