...
UNION
SELECT v.source_id,v.ra,v.dec,v.phot_j_mag,v.phot_j_mag_error,v.phot_h_mag,v.phot_h_mag_error,v.phot_ks_mag,v.phot_ks_mag_error, NULL as ang_dist, NULL as pair_id FROM vvv_sources as v WHERE v.source_id NOT IN 
