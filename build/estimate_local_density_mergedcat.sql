...
SELECT m.source_id,MIN(m.glon),MIN(m.glat), COUNT(radius) N, MIN(radius) Rmin, MAX(radius) R, COUNT(radius)/(4*PI()*POWER(sin(MAX(radius)/3600*PI()/180/2),2))/(4.25*POWER(10,10)) AS density
