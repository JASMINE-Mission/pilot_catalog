...
CASE WHEN t2.source_id IS NOT NULL THEN LEAST(SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',1),
SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',2),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',3),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',4),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',5),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',6),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',7),SPLIT_PART(CONCAT(t1.pair_id,'-',t2.pair_id),'-',8)) ELSE t1.source_id END as aux_ind
