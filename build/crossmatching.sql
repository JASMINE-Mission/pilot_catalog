...
CASE WHEN v.source != 'VVV' THEN v.ra ELSE s.ra END as ra, 
CASE WHEN v.source != 'VVV' THEN v.dec ELSE s.dec END as dec, 
CASE WHEN v.source != 'VVV' THEN CAST('V' AS VARCHAR(1)) ELSE CAST('S' AS VARCHAR(1)) END AS position_source,
...
CASE WHEN v.source != 'VVV' THEN v.ref_epoch ELSE 2002 END as ref_epoch,
...
SELECT ts.tmass_source_id,ts.sirius_source_id,vs.vvv_source_id,
vs.ra as ra, vs.dec as dec, vs.position_source AS position_source,
