...
v.phot_j_mean_mag,CASE WHEN phot_j_std_mag<=0 THEN 0.077 ELSE phot_j_std_mag END,v.phot_j_n_epochs,
v.phot_h_mean_mag,CASE WHEN phot_h_std_mag<=0 THEN 0.075 ELSE phot_h_std_mag END,v.phot_h_n_epochs,
v.phot_ks_mean_mag,CASE WHEN phot_ks_std_mag<=0 THEN 0.095 ELSE phot_ks_std_mag END,v.phot_ks_n_epochs,
