...
CASE WHEN t.phot_j_mag<=12 THEN t.phot_j_mag ELSE  weighted_avg(t.phot_j_mag,1/POWER(t.phot_j_mag_error,2),v.phot_j_mag,1/POWER(v.phot_j_mag_error,2)) as phot_j_mag, 
CASE WHEN t.phot_j_mag<=12 THEN t.phot_j_mag_error ELSE SQRT(weighted_avg_error(1/POWER(t.phot_j_mag_error,2),1/POWER(v.phot_j_mag_error,2))) as phot_j_mag_error,
CASE WHEN t.phot_h_mag<=12 THEN t.phot_h_mag ELSE weighted_avg(t.phot_h_mag,1/POWER(t.phot_h_mag_error,2),v.phot_h_mag,1/POWER(v.phot_h_mag_error,2)) as phot_h_mag, 
CASE WHEN t.phot_h_mag<=12 THEN t.phot_h_mag_error ELSE SQRT(weighted_avg_error(1/POWER(t.phot_h_mag_error,2),1/POWER(v.phot_h_mag_error,2))) as phot_h_mag_error,
CASE WHEN t.phot_ks_mag<=12 THEN t.phot_ks_mag ELSE weighted_avg(t.phot_ks_mag,1/POWER(t.phot_ks_mag_error,2),v.phot_ks_mag,1/POWER(v.phot_ks_mag_error,2)) as phot_ks_mag, 
CASE WHEN t.phot_ks_mag<=12 THEN t.phot_ks_mag_error ELSE SQRT(weighted_avg_error(1/POWER(t.phot_ks_mag_error,2),1/POWER(v.phot_ks_mag_error,2))) as phot_ks_mag_error,
...
CASE WHEN s.phot_j_mag<=12 THEN s.phot_j_mag ELSE weighted_avg(v.phot_j_mag,1/POWER(v.phot_j_mag_error,2),s.phot_j_mag,1/POWER(s.phot_j_mag_error,2)) as phot_j_mag, 
CASE WHEN s.phot_j_mag<=12 THEN s.phot_j_mag_error ELSE SQRT(weighted_avg_error(1/POWER(v.phot_j_mag_error,2),1/POWER(s.phot_j_mag_error,2))) as phot_j_mag_error,
CASE WHEN s.phot_h_mag<=12 THEN s.phot_h_mag ELSE weighted_avg(v.phot_h_mag,1/POWER(v.phot_h_mag_error,2),s.phot_h_mag,1/POWER(s.phot_h_mag_error,2)) as phot_h_mag,
CASE WHEN s.phot_h_mag<=12 THEN s.phot_h_mag_error ELSE SQRT(weighted_avg_error(1/POWER(v.phot_h_mag_error,2),1/POWER(s.phot_h_mag_error,2))) as phot_h_mag_error,
CASE WHEN s.phot_ks_mag<=12 THEN s.phot_ks_mag ELSE weighted_avg(v.phot_ks_mag,1/POWER(v.phot_ks_mag_error,2),s.phot_ks_mag,1/POWER(s.phot_ks_mag_error,2)) as phot_ks_mag, 
CASE WHEN s.phot_ks_mag<=12 THEN s.phot_ks_mag_error ELSE SQRT(weighted_avg_error(1/POWER(v.phot_ks_mag_error,2),1/POWER(s.phot_ks_mag_error,2))) as phot_ks_mag_error,
v.phot_j_mag as vvv_j_mag,v.phot_h_mag as vvv_h_mag,v.phot_ks_mag as vvv_ks_mag,
v.phot_j_mag_error as vvv_j_mag_error,v.phot_h_mag_error as vvv_h_mag_error,v.phot_ks_mag_error as vvv_ks_mag_error,
s.phot_j_mag as sirius_j_mag,s.phot_h_mag as sirius_h_mag,s.phot_ks_mag as sirius_ks_mag,
s.phot_j_mag_error as sirius_j_mag_error,s.phot_h_mag_error as sirius_h_mag_error,s.phot_ks_mag_error as sirius_ks_mag_error,
...
CASE WHEN ts.tmass_j_mag>12 AND ts.sirius_j_mag>12 THEN weighted_avg3(ts.tmass_j_mag,1/POWER(ts.tmass_j_mag_error,2),ts.sirius_j_mag,1/POWER(ts.sirius_j_mag_error,2),vs.vvv_j_mag,1/POWER(vs.vvv_j_mag_error,2)) ELSE ts.phot_j_mag as phot_j_mag, 
CASE WHEN ts.tmass_j_mag>12 AND ts.sirius_j_mag>12 THEN SQRT(weighted_avg_error3(1/POWER(ts.tmass_j_mag_error,2),1/POWER(ts.sirius_j_mag_error,2),1/POWER(vs.vvv_j_mag_error,2))) ELSE ts.phot_j_mag_error as phot_j_mag_error,
CASE WHEN ts.tmass_h_mag>12 AND ts.sirius_h_mag>12 THEN weighted_avg3(ts.tmass_h_mag,1/POWER(ts.tmass_h_mag_error,2),ts.sirius_h_mag,1/POWER(ts.sirius_h_mag_error,2),vs.vvv_h_mag,1/POWER(vs.vvv_h_mag_error,2)) ELSE ts.phot_h_mag as phot_h_mag, 
CASE WHEN ts.tmass_h_mag>12 AND ts.sirius_h_mag>12 THEN SQRT(weighted_avg_error3(1/POWER(ts.tmass_h_mag_error,2),1/POWER(ts.sirius_h_mag_error,2),1/POWER(vs.vvv_h_mag_error,2))) ELSE ts.phot_h_mag_error as phot_h_mag_error,
CASE WHEN ts.tmass_ks_mag>12 AND ts.sirius_ks_mag>12 THEN weighted_avg3(ts.tmass_ks_mag,1/POWER(ts.tmass_ks_mag_error,2),ts.sirius_ks_mag,1/POWER(ts.sirius_ks_mag_error,2),vs.vvv_ks_mag,1/POWER(vs.vvv_ks_mag_error,2)) ELSE ts.phot_ks_mag as phot_ks_mag, 
CASE WHEN ts.tmass_ks_mag>12 AND ts.sirius_ks_mag>12 THEN SQRT(weighted_avg_error3(1/POWER(ts.tmass_ks_mag_error,2),1/POWER(ts.sirius_ks_mag_error,2),1/POWER(vs.vvv_ks_mag_error,2))) ELSE ts.phot_ks_mag_error as phot_ks_mag_error,
