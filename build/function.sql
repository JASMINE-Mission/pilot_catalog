...
RETURNS FLOAT AS $$
  SELECT CASE WHEN $2 IS NOT NULL THEN $1-(0.160*POWER($2,2) - 4.035*$2 + 25.396) ELSE $1 END
$$ LANGUAGE SQL
IMMUTABLE;
...
RETURNS FLOAT AS $$
  SELECT CASE WHEN $2 IS NOT NULL THEN $1-(0.145*POWER($2,2) - 3.699*$2 + 23.547) ELSE $1 END
$$ LANGUAGE SQL
IMMUTABLE;
...
RETURNS FLOAT AS $$
  SELECT CASE WHEN $2 IS NOT NULL THEN $1-(0.158*POWER($2,2) - 3.746*$2 + 22.223) ELSE $1 END
$$ LANGUAGE SQL
IMMUTABLE;
