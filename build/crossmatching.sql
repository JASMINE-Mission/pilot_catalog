...
CASE WHEN v.sourve != 'VVV' THEN v.ra ELSE s.ra as ra, 
CASE WHEN v.sourve != 'VVV' THEN v.dec ELSE s.dec as dec, 
CASE WHEN v.sourve != 'VVV' THEN CAST('V' AS VARCHAR(1)) ELSE CAST('S' AS VARCHAR(1)) AS position_source,
...
CASE WHEN v.sourve != 'VVV' THEN v.ref_epoch ELSE 2002 as ref_epoch,
